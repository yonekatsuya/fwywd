...
export default function MyFuture() {
  return (
    <div className={'-mt-64 h-[570px] bg-no-repeat bg-cover bg-future-img'}>
          ...
          <div className='flex h-full'>
            <div className='w-1/2 h-full'>
              <div>
                ...
                <span className='table-cell text-base-green align-middle'>FUTURE</span>
              </div>
              <div className='pr-6 mt-6 text-left'>{indexCt.futureDesc}</div>
            </div>
            <div className='w-1/2 h-full bg-no-repeat bg-cover bg-future-card-img'></div>
          </div>
        </div>
      </div>
    </div>
